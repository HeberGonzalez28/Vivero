...
public class ControladorTipoProducto implements ActionListener,MouseListener {
	//Principal frm;
	JFrameTipoProducto frm2;
	SentenciasTipoProducto senttpro;
	
	
	public ControladorTipoProducto(JFrameTipoProducto frm2, SentenciasTipoProducto senttpro) 
	{
		this.frm2 = frm2;
